...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
    ...
    @Override
    public List<Check<FlywaySchemaHistoryRecord>> getChecks() {
        return Arrays.<Check<FlywaySchemaHistoryRecord>>asList(
              Internal.createCheck(this, DSL.name("SYS_CT_10105"), "PUBLIC.\"flyway_schema_history\".\"installed_rank\" IS NOT NULL", true)
            , Internal.createCheck(this, DSL.name("SYS_CT_10106"), "PUBLIC.\"flyway_schema_history\".\"description\" IS NOT NULL", true)
            , Internal.createCheck(this, DSL.name("SYS_CT_10107"), "PUBLIC.\"flyway_schema_history\".\"type\" IS NOT NULL", true)
            , Internal.createCheck(this, DSL.name("SYS_CT_10108"), "PUBLIC.\"flyway_schema_history\".\"script\" IS NOT NULL", true)
            , Internal.createCheck(this, DSL.name("SYS_CT_10109"), "PUBLIC.\"flyway_schema_history\".\"installed_by\" IS NOT NULL", true)
            , Internal.createCheck(this, DSL.name("SYS_CT_10110"), "PUBLIC.\"flyway_schema_history\".\"installed_on\" IS NOT NULL", true)
            , Internal.createCheck(this, DSL.name("SYS_CT_10111"), "PUBLIC.\"flyway_schema_history\".\"execution_time\" IS NOT NULL", true)
            , Internal.createCheck(this, DSL.name("SYS_CT_10112"), "PUBLIC.\"flyway_schema_history\".\"success\" IS NOT NULL", true)
        );
    }
